...
- CRITICAL: If the task requires MULTIPLE actions (e.g. "turn off WiFi THEN enable bluetooth", "open X and do Y") or contains words like "then", "and", "both" describing multiple state changes, NEVER use OP — use MACRO_VLM even if each individual action looks like a simple toggle.
